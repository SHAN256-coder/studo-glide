...
import { Shield, GraduationCap, Eye, EyeOff, Mail, Phone } from "lucide-react";
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
        ...
        <form onSubmit={handleEmailAuth} className="glass-card p-5 space-y-4">
          ...
          <p className="text-center text-xs text-muted-foreground">
            {mode === "signup" ? "After sign up, check your email to verify your account" : "Sign in with your email and password"}
          </p>
        </form>
